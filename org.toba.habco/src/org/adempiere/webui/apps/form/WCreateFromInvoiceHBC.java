...
import org.compiere.grid.CreateFromInvoiceHBC;
...
public class WCreateFromInvoiceHBC extends CreateFromInvoiceHBC implements EventListener<Event>, ValueChangeListener
{
	private WCreateFromWindow window;
	
	public WCreateFromInvoiceHBC(GridTab tab) 
	{
		super(tab);
