...
import org.compiere.grid.CreateFromShipmentHBC;
...
public class WCreateFromShipmentHBC extends CreateFromShipmentHBC implements EventListener<Event>, ValueChangeListener
{

	private WCreateFromWindow window;
	
	public WCreateFromShipmentHBC(GridTab tab) 
	{
		super(tab);
