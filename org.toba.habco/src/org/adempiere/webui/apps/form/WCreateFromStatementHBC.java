...
import org.compiere.grid.CreateFromStatementHBC;
 ...
 *
 */
public class WCreateFromStatementHBC extends CreateFromStatementHBC implements EventListener<Event>
{
	private WCreateFromWindow window;
	
	public WCreateFromStatementHBC(GridTab tab) 
	{
		super(tab);
