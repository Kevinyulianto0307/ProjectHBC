 ...
 * @author TommyAng 
 */
public class HBC_CalculateAnnual extends SvrProcess{
				...
				for (int id : calcTempID) {
					...
					if(loadTemp.getC_Activity().getValue().equals(LOADING)){
						...
						for(int id1 : calcTempID){
							...
							if(fromPortID == dischargingTemp.getHBC_PortPosition_ID())
								continue;
							...
							if(dischargingTemp.getC_Activity().getValue().equals(DISCHARGING)){
								...
								price = getPrice(HBC_Trip_ID, fromPortID, dischargingTemp.getHBC_PortPosition_ID(), (Timestamp) dischargingTemp.get_Value("FinishDate"));
