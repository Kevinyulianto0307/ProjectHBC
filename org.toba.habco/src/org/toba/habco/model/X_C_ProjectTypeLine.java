...
/** Generated Model for C_ProjectTypeLine
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_C_ProjectTypeLine extends PO implements I_C_ProjectTypeLine, I_Persistent 
{
    ...
    public X_C_ProjectTypeLine (Properties ctx, int C_ProjectTypeLine_ID, String trxName)
    {
      super (ctx, C_ProjectTypeLine_ID, trxName);
      /** if (C_ProjectTypeLine_ID == 0)
        {
			setC_Phase_ID (0);
			setC_ProjectTypeLine_ID (0);
			setSeqNo (0);
...
// 1
    ...
    /** Load Constructor */
    public X_C_ProjectTypeLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_ProjectTypeLine[")
	...
	/** Set Standard Project Type Line.
		@param C_ProjectTypeLine_ID Standard Project Type Line	  */
	public void setC_ProjectTypeLine_ID (int C_ProjectTypeLine_ID)
	{
		if (C_ProjectTypeLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_ProjectTypeLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_ProjectTypeLine_ID, Integer.valueOf(C_ProjectTypeLine_ID));
	}

	/** Get Standard Project Type Line.
		@return Standard Project Type Line	  */
	public int getC_ProjectTypeLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ProjectTypeLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set C_ProjectTypeLine_UU.
		@param C_ProjectTypeLine_UU C_ProjectTypeLine_UU	  */
	public void setC_ProjectTypeLine_UU (String C_ProjectTypeLine_UU)
	{
		set_Value (COLUMNNAME_C_ProjectTypeLine_UU, C_ProjectTypeLine_UU);
	}

	/** Get C_ProjectTypeLine_UU.
		@return C_ProjectTypeLine_UU	  */
	public String getC_ProjectTypeLine_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_ProjectTypeLine_UU);
	}
