...
/** Generated Model for HBC_ShipPositionLine
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_HBC_ShipPositionLine extends PO implements I_HBC_ShipPositionLine, I_Persistent 
{
    ...
    public X_HBC_ShipPositionLine (Properties ctx, int HBC_ShipPositionLine_ID, String trxName)
    {
      super (ctx, HBC_ShipPositionLine_ID, trxName);
      /** if (HBC_ShipPositionLine_ID == 0)
        {
			setAmountOfCargo (Env.ZERO);
			setDraftBack (Env.ZERO);
			setDraftFront (Env.ZERO);
			setHBC_ShipPositionLine_ID (0);
			setStartDate (new Timestamp( System.currentTimeMillis() ));
			setTotalLiters (Env.ZERO);
        } */
    }

    /** Load Constructor */
    public X_HBC_ShipPositionLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HBC_ShipPositionLine[")
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getHBC_ShipPositionLine_ID()));
    }

	/** Set HBC_ShipPositionLine_UU.
		@param HBC_ShipPositionLine_UU HBC_ShipPositionLine_UU	  */
	public void setHBC_ShipPositionLine_UU (String HBC_ShipPositionLine_UU)
	{
		set_Value (COLUMNNAME_HBC_ShipPositionLine_UU, HBC_ShipPositionLine_UU);
	}

	/** Get HBC_ShipPositionLine_UU.
		@return HBC_ShipPositionLine_UU	  */
	public String getHBC_ShipPositionLine_UU () 
	{
		return (String)get_Value(COLUMNNAME_HBC_ShipPositionLine_UU);
	}
