...
/** Generated Model for HC_Employee
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_HC_Employee extends PO implements I_HC_Employee, I_Persistent 
{
    ...
    public X_HC_Employee (Properties ctx, int HC_Employee_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_HC_Employee (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HC_Employee[")
	...
	{
		if (C_TaxOffice_ID < 1) 
			set_Value (COLUMNNAME_C_TaxOffice_ID, null);
		else 
			set_Value (COLUMNNAME_C_TaxOffice_ID, Integer.valueOf(C_TaxOffice_ID));
	}
	...
	/** Set Duty Date.
		@param DutyDate Duty Date	  */
	public void setDutyDate (Timestamp DutyDate)
	{
		set_Value (COLUMNNAME_DutyDate, DutyDate);
	}
	...
	{
		return (Timestamp)get_Value(COLUMNNAME_DutyDate);
	}
	...
	/** Set HC_Employee_UU.
		@param HC_Employee_UU HC_Employee_UU	  */
	public void setHC_Employee_UU (String HC_Employee_UU)
	{
		set_Value (COLUMNNAME_HC_Employee_UU, HC_Employee_UU);
	}

	/** Get HC_Employee_UU.
		@return HC_Employee_UU	  */
	public String getHC_Employee_UU () 
	{
		return (String)get_Value(COLUMNNAME_HC_Employee_UU);
	}
	...
	{
		if (HC_Religion_ID < 1) 
			set_Value (COLUMNNAME_HC_Religion_ID, null);
		else 
			set_Value (COLUMNNAME_HC_Religion_ID, Integer.valueOf(HC_Religion_ID));
	}
	...
	public void setHC_TaxStatus_ID (int HC_TaxStatus_ID)
	{
		if (HC_TaxStatus_ID < 1) 
			set_Value (COLUMNNAME_HC_TaxStatus_ID, null);
		else 
			set_Value (COLUMNNAME_HC_TaxStatus_ID, Integer.valueOf(HC_TaxStatus_ID));
	}
	...
	/** Set On Leave.
		@param IsOnLeave On Leave	  */
	public void setIsOnLeave (boolean IsOnLeave)
	{
		set_Value (COLUMNNAME_IsOnLeave, Boolean.valueOf(IsOnLeave));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsOnLeave);
		if (oo != null) 
		{
	...
	/** Set Person In Charge.
		@param IsPersonInCharge Person In Charge	  */
	public void setIsPersonInCharge (boolean IsPersonInCharge)
	{
		set_Value (COLUMNNAME_IsPersonInCharge, Boolean.valueOf(IsPersonInCharge));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsPersonInCharge);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_JoinDate, JoinDate);
	}
	...
	{
		return (Timestamp)get_Value(COLUMNNAME_JoinDate);
	}
