...
/** Generated Model for HC_EmployeeJob
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_HC_EmployeeJob extends PO implements I_HC_EmployeeJob, I_Persistent 
{
    ...
    public X_HC_EmployeeJob (Properties ctx, int HC_EmployeeJob_ID, String trxName)
    {
      super (ctx, HC_EmployeeJob_ID, trxName);
      /** if (HC_EmployeeJob_ID == 0)
        {
			setHC_EmployeeJob_ID (0);
        } */
    }

    /** Load Constructor */
    public X_HC_EmployeeJob (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HC_EmployeeJob[")
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getHC_EmployeeJob_ID()));
    }

	/** Set HC_EmployeeJob_UU.
		@param HC_EmployeeJob_UU HC_EmployeeJob_UU	  */
	public void setHC_EmployeeJob_UU (String HC_EmployeeJob_UU)
	{
		set_Value (COLUMNNAME_HC_EmployeeJob_UU, HC_EmployeeJob_UU);
	}

	/** Get HC_EmployeeJob_UU.
		@return HC_EmployeeJob_UU	  */
	public String getHC_EmployeeJob_UU () 
	{
		return (String)get_Value(COLUMNNAME_HC_EmployeeJob_UU);
	}
