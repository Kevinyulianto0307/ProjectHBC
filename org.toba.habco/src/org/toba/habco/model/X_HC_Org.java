...
/** Generated Model for HC_Org
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_HC_Org extends PO implements I_HC_Org, I_Persistent 
{
    ...
    public X_HC_Org (Properties ctx, int HC_Org_ID, String trxName)
    {
      super (ctx, HC_Org_ID, trxName);
      /** if (HC_Org_ID == 0)
        {
			setHC_Org_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_HC_Org (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HC_Org[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	public I_C_CostCenter getC_CostCenter() throws RuntimeException
    {
		return (I_C_CostCenter)MTable.get(getCtx(), I_C_CostCenter.Table_Name)
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getHC_Org_ID()));
    }

	/** Set HC_Org_UU.
		@param HC_Org_UU HC_Org_UU	  */
	public void setHC_Org_UU (String HC_Org_UU)
	{
		set_Value (COLUMNNAME_HC_Org_UU, HC_Org_UU);
	}

	/** Get HC_Org_UU.
		@return HC_Org_UU	  */
	public String getHC_Org_UU () 
	{
		return (String)get_Value(COLUMNNAME_HC_Org_UU);
	}
