 ...
 */
public class HBC_Aging extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		//@phie add new coloumn 
		sql.append(" , oi.dateInvoiced, oi.orderReference"); // 18..19
		//end phie
		if (!p_DateAcct)//FR 1933937
		{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				//@phie
				Timestamp dateInvoiced = rs.getTimestamp(18);
				String orderReference = rs.getString(19);
				//end phie
					...
					|| C_InvoicePaySchedule_ID != aging.getC_InvoicePaySchedule_ID())
				{
					...
					aging.set_ValueOfColumn("OrderReference", orderReference);
					//end phie
				}
				//	Fill Buckets
