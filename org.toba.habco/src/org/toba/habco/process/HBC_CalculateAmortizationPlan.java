 ...
 */
public class HBC_CalculateAmortizationPlan extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		for(int i=1; i <= numberOfPeriod; i++){
			...
			//line.setC_Period_ID(nextPeriod.getC_Period_ID());
			//  custom column habco
			line.set_ValueOfColumn("HBC_Tugboat_ID", amortizationPlan.get_Value("HBC_Tugboat_ID"));
			line.set_ValueOfColumn("HBC_Barge_ID", amortizationPlan.get_Value("HBC_Barge_ID"));
			line.saveEx();
