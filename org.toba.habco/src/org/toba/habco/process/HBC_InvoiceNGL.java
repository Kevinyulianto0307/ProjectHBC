 ...
 */
public class HBC_InvoiceNGL extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		sql = new StringBuilder("INSERT INTO T_InvoiceGL (AD_Client_ID, AD_Org_ID, IsActive, Created,CreatedBy, Updated,UpdatedBy,")
			...
			.append( getAD_PInstance_ID()).append(", i.C_Invoice_ID, i.GrandTotal, invoiceOpenToDate(i.C_Invoice_ID, 0,"+dateStr+"), ")
		    ...
		    .append("WHERE InvoiceOpenToDate(i.C_Invoice_ID,0, "+dateStr+")>0 ")
